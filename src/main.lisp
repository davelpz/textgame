...
;; blah blah blah.
(defparameter *wizard-nodes* '((living-room (you are in the living-room. a wizard snoring loudly on the couch.))
...
(defun walk (direction)
  (let ((next (find direction (cdr (assoc *location* *wizard-edges*)) :key #'cadr)))
    (if next
